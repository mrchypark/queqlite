...
async fn publish_result(archive: &ObjectArchiveStore) -> queqlite_archive::Result<()> {
...
fn generation_prefix(generation: u64) -> String {
    format!("queqlite/cluster-a/checkpoints/epoch-00000000000000000007/config-00000000000000000003/generation-{generation:020}")
}
